...
const HTTP_POLICY = new Map([
  ...
  ['GET /api/egress/manifest', 'capability.read'],
  ['GET /api/harness/attempts', 'capability.read'], ['GET /api/harness/attempt', 'capability.read'], ['GET /api/harness/attempt/events', 'capability.read'],
